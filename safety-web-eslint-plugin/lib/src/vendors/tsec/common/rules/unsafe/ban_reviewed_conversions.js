...
let errMsg = 'Use of reviewed conversions to safe values requires security reviews and approval.';
let bannedValues = [
...
class Rule extends conformance_pattern_rule_1.ConformancePatternRule {
    constructor(configuration = {}) {
        super(Object.assign({ errorCode: conformance_pattern_rule_1.ErrorCode.CONFORMANCE_PATTERN, errorMessage: errMsg, kind: conformance_pattern_rule_1.PatternKind.BANNED_NAME, values: bannedValues, name: Rule.RULE_NAME }, configuration));
    }
}
exports.Rule = Rule;
Rule.RULE_NAME = 'ban-reviewed-conversions';
//# sourceMappingURL=ban_reviewed_conversions.js.map