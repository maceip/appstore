...
exports.isExpressionValueUsedOrVoid = isExpressionValueUsedOrVoid;
 ...
 * conformance checks.
 */
function isExpressionValueUsedOrVoid(node) {
    return ts.isVoidExpression(node.parent) ||
        tsutils.isExpressionValueUsed(node);
}
//# sourceMappingURL=is_expression_value_used_or_void.js.map