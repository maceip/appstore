...
exports.overridePatternConfig = overridePatternConfig;
/**
...
(function (PatternKind) {
    ...
    PatternKind["BANNED_IMPORTED_NAME"] = "banned-imported-name";
...
})(PatternKind || (exports.PatternKind = PatternKind = {}));
/**
 * Internal function to override the rule config properties before passing to
 * parent constructor.
 */
function overridePatternConfig(config) {
    return config;
}
//# sourceMappingURL=pattern_config.js.map