 ...
 * that).
 */
export declare function maybeAddNamedImport(source: ts.SourceFile, importWhat: string, fromModule: string, importAs?: string, tazeComment?: string): IndividualChange | undefined;
/**
 ...
 * that).
 */
export declare function maybeAddNamespaceImport(source: ts.SourceFile, fromModule: string, importAs: string, tazeComment?: string): IndividualChange | undefined;
